...
public class AutoTestCase extends TestCase {
	...
	public static long timerSampleBefore = 0; 
	public static long timerSampleAfter = 0; 
	...
	public static String artifactPath = AutomationSettings.getArtifactPath();
